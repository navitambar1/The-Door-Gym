...
export default function EducationVideosScreen() {
  ...
  const { data: videos, isLoading } = useVideos(undefined, catId);
  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
        ...
        <View style={styles.splitView}>
          ...
          <View style={styles.sidebar}>
            <View style={styles.sidebarHeader}>
              <Text style={styles.sidebarHeaderText}>{name ?? "Videos"}</Text>
            </View>
            <FlatList
              ref={sidebarRef}
              data={sorted}
            ...
            {current && (
              <>
                ...
                <FlatList
                  ...
                  renderItem={({ item: v }) => (
                    <>
                      <Text style={styles.descHeading}>Video description</Text>
                      {!!v.Description && (
      ...
      {/* Bottom bar — paddingBottom keeps buttons above Android nav bar */}
      {!isLoading && sorted.length > 0 && (
